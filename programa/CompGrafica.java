...
public class CompGrafica {
	...
	public static void main(String[] args) {
		...
		System.out.print("Digite o numero de pontos da sua forma geométrica tridimensional: ");
		...
		System.out.print("Quantas transformações você quer fazer na sua forma geométrica? ");
		int numTrans = in.nextInt();
		
		for (int i = 0; i < numTrans; i++) {
			System.out.print("Qual será sua " + (i + 1) + "ª transformação? Digite 1 para mudança de escala, 2 para rotação ao redor de um eixo ordenado ou 3 para translação: ");
			int trans;
			...
			if (trans == 1) {
				...
				System.out.print("Você quer rotacionar quantos graus sobre esse eixo? Para rotação no sentido horário, digite o ângulo, em graus, negativo: ");
	...
	public static void imprimirPontos(double[][] matriz) {
		System.out.println("Estes são os pontos da sua forma geometrica agora: ");
